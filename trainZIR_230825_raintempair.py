# UPDATES: 
# 1. Constants and rain and tempair
...
weather_vars = ['rain_','tempair_'] #['evaptrans_','runsurf_','runsub_','rain_','tempair_','watersoil_','tempsoil_']
...
blurb = blurb + '\nConstants and rain and tempair.'
