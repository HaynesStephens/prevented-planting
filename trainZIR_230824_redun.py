# UPDATES: 
# 1. Take out redundant features based on correlation comparison.
...
weather_vars = ['rain_','watersoil_','tempsoil_'] #['evaptrans_','runsurf_','runsub_','rain_','tempair_','watersoil_','tempsoil_']
...
blurb = blurb + '\nRemoved all features considered redundant based on corr.'
